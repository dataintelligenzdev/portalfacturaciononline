    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
                ...
                <div class="sidebar-brand-text mx-3">Portal <sup>Facturacion</sup></div>
            </a>
            ...
            <!-- Nav Item - Tables -->
            <li class="nav-item  {{ ((request()->routeIs('metodo_pagos'))?'active':'')}}">
                <a class="nav-link" href="{{ route('metodo_pagos') }}">
